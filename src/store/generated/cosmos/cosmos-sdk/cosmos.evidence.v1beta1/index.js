  ...
  actions: {
    ...
    async QueryEvidence(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryEvidence API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryAllEvidence(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryAllEvidence API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async sendMsgSubmitEvidence(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgSubmitEvidence:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
