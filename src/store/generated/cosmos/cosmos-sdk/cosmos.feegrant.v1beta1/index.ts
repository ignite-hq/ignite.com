  ...
  actions: {
    ...
    async QueryAllowance(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryAllowance API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryAllowances(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryAllowances API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async sendMsgRevokeAllowance(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRevokeAllowance:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgRevokeAllowance:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgGrantAllowance(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgGrantAllowance:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgGrantAllowance:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
