  ...
  actions: {
    ...
    async QueryBalance(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryBalance API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryAllBalances(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryAllBalances API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryTotalSupply(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryTotalSupply API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QuerySupplyOf(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QuerySupplyOf API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryDenomMetadata(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDenomMetadata API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryDenomsMetadata(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDenomsMetadata API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
