  ...
  actions: {
    ...
    async QueryValidators(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryValidators API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryValidatorDelegations(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryValidatorDelegations API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryValidatorUnbondingDelegations(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryValidatorUnbondingDelegations API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegation(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegation API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryUnbondingDelegation(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryUnbondingDelegation API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegatorDelegations(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegatorDelegations API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegatorUnbondingDelegations(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegatorUnbondingDelegations API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryRedelegations(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryRedelegations API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegatorValidators(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegatorValidators API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegatorValidator(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegatorValidator API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryHistoricalInfo(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryHistoricalInfo API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryPool(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryPool API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async sendMsgCreateValidator(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgCreateValidator:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgCreateValidator:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgEditValidator(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgEditValidator:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgEditValidator:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgUndelegate({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgUndelegate:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgBeginRedelegate(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgBeginRedelegate:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgBeginRedelegate:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgDelegate({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgDelegate:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async MsgUndelegate({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgUndelegate:Create  Could not create message: ' +
              e.message
          )
        }
      }
    ...
    async MsgDelegate({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgDelegate:Create  Could not create message: ' +
              e.message
          )
        }
      }
