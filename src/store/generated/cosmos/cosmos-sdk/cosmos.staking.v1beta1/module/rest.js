...
export class Api extends HttpClient {
  constructor() {
     ...
     */
    this.queryDelegatorDelegations = (delegator_addr, query, params = {}) =>
      this.request({
     ...
     */
    this.queryRedelegations = (delegator_addr, query, params = {}) =>
      this.request({
    ...
    /**
       ...
       */
    this.queryDelegatorValidators = (delegator_addr, query, params = {}) =>
      this.request({
     ...
     */
    this.queryValidator = (validator_addr, params = {}) =>
      this.request({
     ...
     */
    this.queryValidatorDelegations = (validator_addr, query, params = {}) =>
      this.request({
     ...
     */
    this.queryDelegation = (validator_addr, delegator_addr, params = {}) =>
      this.request({
