  ...
  actions: {
    ...
    async QueryProposal(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryProposal API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryProposals(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryProposals API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryVote(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryVote API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryVotes(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryVotes API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryDeposit(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDeposit API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryDeposits(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDeposits API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryTallyResult(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryTallyResult API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async sendMsgSubmitProposal(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgSubmitProposal:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgSubmitProposal:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgVoteWeighted({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgVoteWeighted:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgVote({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgVote:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgDeposit({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgDeposit:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async MsgVoteWeighted({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgVoteWeighted:Create  Could not create message: ' +
              e.message
          )
        }
      }
