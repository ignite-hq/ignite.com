  ...
  actions: {
    ...
    async QueryValidatorOutstandingRewards(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryValidatorOutstandingRewards API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryValidatorCommission(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryValidatorCommission API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryValidatorSlashes(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryValidatorSlashes API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegationRewards(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegationRewards API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDelegationTotalRewards(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegationTotalRewards API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryDelegatorWithdrawAddress(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDelegatorWithdrawAddress API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryCommunityPool(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryCommunityPool API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async sendMsgWithdrawDelegatorReward(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgWithdrawDelegatorReward:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgSetWithdrawAddress(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgSetWithdrawAddress:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgWithdrawValidatorCommission(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgWithdrawValidatorCommission:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgFundCommunityPool(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgFundCommunityPool:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
