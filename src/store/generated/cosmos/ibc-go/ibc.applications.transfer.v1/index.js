  ...
  actions: {
    ...
    async QueryDenomTrace(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDenomTrace API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    async QueryDenomTraces(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryDenomTraces API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async sendMsgTransfer({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgTransfer:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async MsgTransfer({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgTransfer:Create  Could not create message: ' +
              e.message
          )
        }
      }
