...
export default {
  ...
  CosmosIbcGoIbcApplicationsTransferV2: load(
    CosmosIbcGoIbcApplicationsTransferV2,
    'ibc.applications.transfer.v2'
  ),
  TendermintFundraisingTendermintFundraising: load(
    TendermintFundraisingTendermintFundraising,
    'tendermint.fundraising'
  ),
  TendermintSpnTendermintSpnCampaign: load(
    TendermintSpnTendermintSpnCampaign,
    'tendermint.spn.campaign'
  ),
  TendermintSpnTendermintSpnLaunch: load(
    TendermintSpnTendermintSpnLaunch,
    'tendermint.spn.launch'
  ),
  TendermintSpnTendermintSpnMonitoringc: load(
    TendermintSpnTendermintSpnMonitoringc,
    'tendermint.spn.monitoringc'
  ),
  TendermintSpnTendermintSpnProfile: load(
    TendermintSpnTendermintSpnProfile,
    'tendermint.spn.profile'
  ),
  TendermintSpnTendermintSpnReward: load(
    TendermintSpnTendermintSpnReward,
    'tendermint.spn.reward'
  )
}
