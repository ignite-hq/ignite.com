...
const getDefaultState = () => {
  return {
    ...
    _Structure: {
      ...
      MainnetVestingAccount: getStructure(
        MainnetVestingAccount.fromPartial({})
      ),
  ...
  actions: {
    ...
    async QueryCampaign(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryCampaign API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryCampaignAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryCampaignAll({
              ...query,
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryCampaignAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getCampaignAll']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryCampaignAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryCampaignChains(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        commit('QUERY', {
          query: 'CampaignChains',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryCampaignChains',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getCampaignChains']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryCampaignChains API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryMainnetAccount(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryMainnetAccount(key.campaignID, key.address)
        ).data

        commit('QUERY', {
          query: 'MainnetAccount',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryMainnetAccount',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getMainnetAccount']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryMainnetAccount API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryMainnetAccountAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryMainnetAccountAll({
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        commit('QUERY', {
          query: 'MainnetAccountAll',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryMainnetAccountAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getMainnetAccountAll']({ params: { ...key }, query }) ?? {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:QueryMainnetAccountAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryMainnetVestingAccount(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryMainnetVestingAccount(
            key.campaignID,
            key.address
          )
        ).data
        ...
        commit('QUERY', {
          query: 'MainnetVestingAccount',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryMainnetVestingAccount',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getMainnetVestingAccount']({ params: { ...key }, query }) ??
          {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:QueryMainnetVestingAccount API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryMainnetVestingAccountAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        const key = params ?? {}
        const queryClient = await initQueryClient(rootGetters)
        let value = (await queryClient.queryMainnetVestingAccountAll(query))
          .data
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryMainnetVestingAccountAll({
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        commit('QUERY', {
          query: 'MainnetVestingAccountAll',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryMainnetVestingAccountAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getMainnetVestingAccountAll']({
            params: { ...key },
            query
          }) ?? {}
        )
        ...
        throw new Error(
          'QueryClient:QueryMainnetVestingAccountAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async sendMsgBurnVouchers({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgBurnVouchers:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgMintVouchers({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgMintVouchers:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgRedeemVouchers(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRedeemVouchers:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgRedeemVouchers:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgAddShares({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgAddShares:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgAddVestingOptions(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgAddVestingOptions:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgUnredeemVouchers(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgUnredeemVouchers:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgUnredeemVouchers:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgCreateCampaign(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgCreateCampaign:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgCreateCampaign:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgInitializeMainnet(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgInitializeMainnet:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgEditCampaign({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgEditCampaign:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgUpdateTotalSupply(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgUpdateTotalSupply:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgUpdateTotalShares(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgUpdateTotalShares:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async MsgBurnVouchers({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgBurnVouchers:Create Could not create message: ' +
              e.message
          )
        }
      }
    ...
    async MsgMintVouchers({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgMintVouchers:Create Could not create message: ' +
              e.message
          )
        }
      }
    ...
    async MsgAddShares({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgAddShares:Create Could not create message: ' +
              e.message
          )
        }
      }
    ...
    async MsgEditCampaign({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgEditCampaign:Create Could not create message: ' +
              e.message
          )
        }
      }
