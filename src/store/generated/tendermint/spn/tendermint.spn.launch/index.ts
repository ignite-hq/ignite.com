...
import { Peer } from "./module/types/launch/genesis_validator"
import { Peer_HTTPTunnel } from "./module/types/launch/genesis_validator"
import { Params } from "./module/types/launch/params"
import { LaunchTimeRange } from "./module/types/launch/params"
...
export { Chain, InitialGenesis, DefaultInitialGenesis, GenesisURL, RequestCounter, GenesisAccount, GenesisValidator, Peer, Peer_HTTPTunnel, Params, LaunchTimeRange, Request, RequestContent, AccountRemoval, ValidatorRemoval, VestingAccount, VestingOptions, DelayedVesting };
...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						Peer_HTTPTunnel: getStructure(Peer_HTTPTunnel.fromPartial({})),
						Params: getStructure(Params.fromPartial({})),
						LaunchTimeRange: getStructure(LaunchTimeRange.fromPartial({})),
...
export default {
	...
	actions: {
		...
		async QueryChain({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryChain', payload: { options: { all }, params: {...key},query }})
				return getters['getChain']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryChain API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryChainAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryChainAll({...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'ChainAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryChainAll', payload: { options: { all }, params: {...key},query }})
				return getters['getChainAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryChainAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryGenesisAccount({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryGenesisAccount', payload: { options: { all }, params: {...key},query }})
				return getters['getGenesisAccount']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryGenesisAccount API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryGenesisAccountAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryGenesisAccountAll( key.launchID, {...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'GenesisAccountAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryGenesisAccountAll', payload: { options: { all }, params: {...key},query }})
				return getters['getGenesisAccountAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryGenesisAccountAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryVestingAccount({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryVestingAccount', payload: { options: { all }, params: {...key},query }})
				return getters['getVestingAccount']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryVestingAccount API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryVestingAccountAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryVestingAccountAll( key.launchID, {...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'VestingAccountAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryVestingAccountAll', payload: { options: { all }, params: {...key},query }})
				return getters['getVestingAccountAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryVestingAccountAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryGenesisValidator({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryGenesisValidator', payload: { options: { all }, params: {...key},query }})
				return getters['getGenesisValidator']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryGenesisValidator API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryGenesisValidatorAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryGenesisValidatorAll( key.launchID, {...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'GenesisValidatorAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryGenesisValidatorAll', payload: { options: { all }, params: {...key},query }})
				return getters['getGenesisValidatorAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryGenesisValidatorAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryRequestAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await queryClient.queryRequestAll( key.launchID, {...query, 'pagination.key':(<any> value).pagination.next_key})).data
					value = mergeResults(value, next_values);
				}
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgTriggerLaunch:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgTriggerLaunch:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRequestAddVestingAccount:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgRequestAddVestingAccount:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRevertLaunch:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgRevertLaunch:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgCreateChain:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgCreateChain:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRequestAddAccount:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgRequestAddAccount:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRequestRemoveValidator:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgRequestRemoveValidator:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRequestRemoveAccount:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgRequestRemoveAccount:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgSettleRequest:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgSettleRequest:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgEditChain:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgEditChain:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
	...
	gas: "200000" }, memo})
				...
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgRequestAddValidator:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgRequestAddValidator:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		...
		async MsgTriggerLaunch({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgTriggerLaunch:Create Could not create message: ' + e.message)
		...
		async MsgRequestAddVestingAccount({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgRequestAddVestingAccount:Create Could not create message: ' + e.message)
		...
		async MsgRevertLaunch({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgRevertLaunch:Create Could not create message: ' + e.message)
		...
		async MsgCreateChain({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgCreateChain:Create Could not create message: ' + e.message)
		...
		async MsgRequestAddAccount({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgRequestAddAccount:Create Could not create message: ' + e.message)
		...
		async MsgRequestRemoveValidator({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgRequestRemoveValidator:Create Could not create message: ' + e.message)
		...
		async MsgRequestRemoveAccount({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgRequestRemoveAccount:Create Could not create message: ' + e.message)
		...
		async MsgSettleRequest({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgSettleRequest:Create Could not create message: ' + e.message)
		...
		async MsgEditChain({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgEditChain:Create Could not create message: ' + e.message)
		...
		async MsgRequestAddValidator({ rootGetters }, { value }) {
			try {
				...
				if (e == MissingWalletError) {
					...
					throw new Error('TxClient:MsgRequestAddValidator:Create Could not create message: ' + e.message)
