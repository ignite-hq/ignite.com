...
const getDefaultState = () => {
  return {
    ...
    _Structure: {
      ...
      DefaultInitialGenesis: getStructure(
        DefaultInitialGenesis.fromPartial({})
      ),
  ...
  actions: {
    ...
    async QueryChain(
      ...
      try {
        ...
        throw new Error(
          'QueryClient:QueryChain API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryChainAll(
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryChainAll({
              ...query,
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryChainAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getChainAll']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryChainAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryGenesisAccount(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryGenesisAccount(key.launchID, key.address)
        ).data
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryGenesisAccount',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getGenesisAccount']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryGenesisAccount API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryGenesisAccountAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryGenesisAccountAll(key.launchID, query)
        ).data
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryGenesisAccountAll(key.launchID, {
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        commit('QUERY', {
          query: 'GenesisAccountAll',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryGenesisAccountAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getGenesisAccountAll']({ params: { ...key }, query }) ?? {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:QueryGenesisAccountAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryVestingAccount(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryVestingAccount(key.launchID, key.address)
        ).data

        commit('QUERY', {
          query: 'VestingAccount',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryVestingAccount',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getVestingAccount']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryVestingAccount API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryVestingAccountAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryVestingAccountAll(key.launchID, query)
        ).data
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryVestingAccountAll(key.launchID, {
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        commit('QUERY', {
          query: 'VestingAccountAll',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryVestingAccountAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getVestingAccountAll']({ params: { ...key }, query }) ?? {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:QueryVestingAccountAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryGenesisValidator(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryGenesisValidator(key.launchID, key.address)
        ).data

        commit('QUERY', {
          query: 'GenesisValidator',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryGenesisValidator',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getGenesisValidator']({ params: { ...key }, query }) ?? {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:QueryGenesisValidator API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryGenesisValidatorAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryGenesisValidatorAll(key.launchID, query)
        ).data
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryGenesisValidatorAll(key.launchID, {
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        commit('QUERY', {
          query: 'GenesisValidatorAll',
          key: { params: { ...key }, query },
          value
        })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryGenesisValidatorAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return (
          getters['getGenesisValidatorAll']({ params: { ...key }, query }) ?? {}
        )
      } catch (e) {
        throw new Error(
          'QueryClient:QueryGenesisValidatorAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async QueryRequest(
      ...
      try {
        ...
        const queryClient = await initQueryClient(rootGetters)
        let value = (
          await queryClient.queryRequest(key.launchID, key.requestID)
        ).data
        ...
        throw new Error(
          'QueryClient:QueryRequest API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },

    async QueryRequestAll(
      { commit, rootGetters, getters },
      {
        options: { subscribe, all } = { subscribe: false, all: false },
        params,
      ...
      try {
        const key = params ?? {}
        const queryClient = await initQueryClient(rootGetters)
        let value = (await queryClient.queryRequestAll(key.launchID, query))
          .data
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryRequestAll(key.launchID, {
              ...query,
              'pagination.key': (<any>value).pagination.next_key
            })
          ).data
        ...
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryRequestAll',
            payload: { options: { all }, params: { ...key }, query }
          })
        return getters['getRequestAll']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new Error(
          'QueryClient:QueryRequestAll API Node Unavailable. Could not perform query: ' +
            e.message
        )
      }
    },
    ...
    async sendMsgTriggerLaunch(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgTriggerLaunch:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgTriggerLaunch:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgRequestAddVestingAccount(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRequestAddVestingAccount:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgRevertLaunch({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRevertLaunch:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgCreateChain({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgCreateChain:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgRequestAddAccount(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRequestAddAccount:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgRequestRemoveValidator(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRequestRemoveValidator:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgRequestRemoveAccount(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRequestRemoveAccount:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgSettleRequest(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgSettleRequest:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
            'TxClient:MsgSettleRequest:Send Could not broadcast Tx: ' +
              e.message
          )
        }
      }
    ...
    async sendMsgEditChain({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgEditChain:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async sendMsgRequestAddValidator(
      ...
      try {
        ...
        if (e == MissingWalletError) {
          throw new Error(
            'TxClient:MsgRequestAddValidator:Init Could not initialize signing client. Wallet is required.'
          )
        } else {
          throw new Error(
    ...
    async MsgRevertLaunch({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgRevertLaunch:Create Could not create message: ' +
              e.message
          )
        }
      }
    ...
    async MsgCreateChain({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgCreateChain:Create Could not create message: ' +
              e.message
          )
        }
      }
    ...
    async MsgEditChain({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new Error(
            'TxClient:MsgEditChain:Create Could not create message: ' +
              e.message
          )
        }
      }
