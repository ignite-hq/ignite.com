...
export const Chain = {
  encode(message: Chain, writer: Writer = Writer.create()): Writer {
    ...
    if (message.consumerRevisionHeight !== 0) {
      writer.uint32(104).int64(message.consumerRevisionHeight);
    }
    if (message.monitoringConnected === true) {
      writer.uint32(112).bool(message.monitoringConnected);
    }
    if (message.metadata.length !== 0) {
      writer.uint32(122).bytes(message.metadata);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          break;
        case 13:
          message.consumerRevisionHeight = longToNumber(reader.int64() as Long);
          break;
        case 14:
          message.monitoringConnected = reader.bool();
          break;
        case 15:
  ...
  fromJSON(object: any): Chain {
    ...
    if (
      object.monitoringConnected !== undefined &&
      object.monitoringConnected !== null
    ) {
      message.monitoringConnected = Boolean(object.monitoringConnected);
    } else {
      message.monitoringConnected = false;
    }
  ...
  toJSON(message: Chain): unknown {
    ...
    message.monitoringConnected !== undefined &&
      (obj.monitoringConnected = message.monitoringConnected);
  ...
  fromPartial(object: DeepPartial<Chain>): Chain {
    ...
    if (
      ...
      message.monitoringConnected = object.monitoringConnected;
    } else {
      message.monitoringConnected = false;
    }
    if (object.metadata !== undefined && object.metadata !== null) {
