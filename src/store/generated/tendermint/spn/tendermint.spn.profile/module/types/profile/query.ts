...
import { Validator, ValidatorByOperatorAddress } from "../profile/validator";
import {
  PageRequest,
  PageResponse,
...
export interface QueryGetValidatorByOperatorAddressRequest {
  operatorAddress: string;
}

export interface QueryGetValidatorByOperatorAddressResponse {
  validatorByOperatorAddress: ValidatorByOperatorAddress | undefined;
}
...
const baseQueryGetValidatorByOperatorAddressRequest: object = {
  operatorAddress: "",
};

export const QueryGetValidatorByOperatorAddressRequest = {
  encode(
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetValidatorByOperatorAddressRequest,
    } as QueryGetValidatorByOperatorAddressRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetValidatorByOperatorAddressRequest {
    const message = {
      ...baseQueryGetValidatorByOperatorAddressRequest,
    } as QueryGetValidatorByOperatorAddressRequest;
    if (
  ...
  toJSON(message: QueryGetValidatorByOperatorAddressRequest): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<QueryGetValidatorByOperatorAddressRequest>
  ): QueryGetValidatorByOperatorAddressRequest {
    const message = {
      ...baseQueryGetValidatorByOperatorAddressRequest,
    } as QueryGetValidatorByOperatorAddressRequest;
...
const baseQueryGetValidatorByOperatorAddressResponse: object = {};

export const QueryGetValidatorByOperatorAddressResponse = {
  encode(
    message: QueryGetValidatorByOperatorAddressResponse,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.validatorByOperatorAddress !== undefined) {
      ValidatorByOperatorAddress.encode(
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetValidatorByOperatorAddressResponse,
    } as QueryGetValidatorByOperatorAddressResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.validatorByOperatorAddress = ValidatorByOperatorAddress.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): QueryGetValidatorByOperatorAddressResponse {
    const message = {
      ...baseQueryGetValidatorByOperatorAddressResponse,
    } as QueryGetValidatorByOperatorAddressResponse;
    if (
      object.validatorByOperatorAddress !== undefined &&
      object.validatorByOperatorAddress !== null
    ) {
      message.validatorByOperatorAddress = ValidatorByOperatorAddress.fromJSON(
        object.validatorByOperatorAddress
      );
    } else {
      message.validatorByOperatorAddress = undefined;
    }
    return message;
  },

  toJSON(message: QueryGetValidatorByOperatorAddressResponse): unknown {
    const obj: any = {};
    message.validatorByOperatorAddress !== undefined &&
      (obj.validatorByOperatorAddress = message.validatorByOperatorAddress
        ? ValidatorByOperatorAddress.toJSON(message.validatorByOperatorAddress)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetValidatorByOperatorAddressResponse>
  ): QueryGetValidatorByOperatorAddressResponse {
    const message = {
      ...baseQueryGetValidatorByOperatorAddressResponse,
    } as QueryGetValidatorByOperatorAddressResponse;
    if (
      ...
      message.validatorByOperatorAddress = ValidatorByOperatorAddress.fromPartial(
        object.validatorByOperatorAddress
      );
    } else {
      message.validatorByOperatorAddress = undefined;
...
export interface Query {
  ...
  ValidatorByOperatorAddress(
    request: QueryGetValidatorByOperatorAddressRequest
  ): Promise<QueryGetValidatorByOperatorAddressResponse>;
...
export class QueryClientImpl implements Query {
  ...
  ValidatorByOperatorAddress(
    ...
    const data = QueryGetValidatorByOperatorAddressRequest.encode(
      request
    ).finish();
    const promise = this.rpc.request(
      "tendermint.spn.profile.Query",
    ...
    return promise.then((data) =>
      QueryGetValidatorByOperatorAddressResponse.decode(new Reader(data))
    );
  }
