...
export const GenesisState = {
  encode(message: GenesisState, writer: Writer = Writer.create()): Writer {
    ...
    for (const v of message.validatorByOperatorAddressList) {
      ValidatorByOperatorAddress.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    for (const v of message.coordinatorList) {
      Coordinator.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    if (message.coordinatorCounter !== 0) {
      writer.uint32(32).uint64(message.coordinatorCounter);
    }
    for (const v of message.coordinatorByAddressList) {
      CoordinatorByAddress.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): GenesisState {
    ...
    message.validatorByOperatorAddressList = [];
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.validatorByOperatorAddressList.push(
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      object.validatorByOperatorAddressList !== undefined &&
      object.validatorByOperatorAddressList !== null
    ) {
      for (const e of object.validatorByOperatorAddressList) {
        message.validatorByOperatorAddressList.push(
          ValidatorByOperatorAddress.fromJSON(e)
        );
      }
    }
    if (
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.validatorByOperatorAddressList) {
      obj.validatorByOperatorAddressList = message.validatorByOperatorAddressList.map(
        (e) => (e ? ValidatorByOperatorAddress.toJSON(e) : undefined)
      );
    } else {
      obj.validatorByOperatorAddressList = [];
    }
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (
      ...
      for (const e of object.validatorByOperatorAddressList) {
        message.validatorByOperatorAddressList.push(
          ValidatorByOperatorAddress.fromPartial(e)
        );
      }
    }
    if (
