...
const txClient = async (
  ...
  return {
    ...
    msgCreateCoordinator: (data: MsgCreateCoordinator): EncodeObject => ({
      ...
      value: MsgCreateCoordinator.fromPartial(data)
    }),
    msgUpdateCoordinatorAddress: (
      data: MsgUpdateCoordinatorAddress
    ): EncodeObject => ({
      typeUrl: '/tendermint.spn.profile.MsgUpdateCoordinatorAddress',
      value: MsgUpdateCoordinatorAddress.fromPartial(data)
    }),
    msgUpdateCoordinatorDescription: (
      data: MsgUpdateCoordinatorDescription
    ): EncodeObject => ({
      typeUrl: '/tendermint.spn.profile.MsgUpdateCoordinatorDescription',
      value: MsgUpdateCoordinatorDescription.fromPartial(data)
    }),
    msgDisableCoordinator: (data: MsgDisableCoordinator): EncodeObject => ({
      typeUrl: '/tendermint.spn.profile.MsgDisableCoordinator',
      value: MsgDisableCoordinator.fromPartial(data)
    }),
    msgUpdateValidatorDescription: (
      data: MsgUpdateValidatorDescription
    ): EncodeObject => ({
      typeUrl: '/tendermint.spn.profile.MsgUpdateValidatorDescription',
      value: MsgUpdateValidatorDescription.fromPartial(data)
    }),
    msgAddValidatorOperatorAddress: (
      data: MsgAddValidatorOperatorAddress
    ): EncodeObject => ({
      typeUrl: '/tendermint.spn.profile.MsgAddValidatorOperatorAddress',
      value: MsgAddValidatorOperatorAddress.fromPartial(data)
    })
  }
}
