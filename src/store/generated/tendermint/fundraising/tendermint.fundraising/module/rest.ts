...
export interface FundraisingParams {
  auctionCreationFee?: V1Beta1Coin[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cosmos/fundraising/v1beta1/auctions/{auctionId}
   */
  queryAuction = (auctionId: string, params: RequestParams = {}) =>
    this.request<FundraisingQueryAuctionResponse, RpcStatus>({
      path: `/cosmos/fundraising/v1beta1/auctions/${auctionId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cosmos/fundraising/v1beta1/auctions/{auctionId}/bids
   */
  queryBids = (
    auctionId: string,
    query?: {
    ...
    this.request<FundraisingQueryBidsResponse, RpcStatus>({
      path: `/cosmos/fundraising/v1beta1/auctions/${auctionId}/bids`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmos/fundraising/v1beta1/auctions/{auctionId}/bids/{sequence}
   */
  queryBid = (auctionId: string, sequence: string, params: RequestParams = {}) =>
    this.request<FundraisingQueryBidResponse, RpcStatus>({
      path: `/cosmos/fundraising/v1beta1/auctions/${auctionId}/bids/${sequence}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cosmos/fundraising/v1beta1/auctions/{auctionId}/vestings
   */
  queryVestings = (auctionId: string, params: RequestParams = {}) =>
    this.request<FundraisingQueryVestingsResponse, RpcStatus>({
      path: `/cosmos/fundraising/v1beta1/auctions/${auctionId}/vestings`,
      method: "GET",
      format: "json",
      ...params,
    });
