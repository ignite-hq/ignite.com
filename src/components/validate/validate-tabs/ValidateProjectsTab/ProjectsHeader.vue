...
const selectedProjectSort = [
  { id: 'upcoming', name: 'Upcoming activity' },
      ...
      <Listbox v-slot="{ open }" v-model="store.selectedPageFilter">
        ...
        >
          ...
          <ListboxOptions class="requests-dropdown-list">
            ...
            <div
              class="flex items-center justify-between border-t border-border py-3 px-6"
            >
              <IgniteText as="div" class="flex items-center">
                <IconArchived class="mr-3" />
                <span>Archived</span>
              </IgniteText>
              <IgniteToggle label="Hidden" active-label="Shown" />
            </div>
          </ListboxOptions>
        </div>
      </Listbox>
