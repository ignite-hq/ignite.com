...
.token-avatar {
  @apply flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-[24px] bg-center bg-no-repeat text-3 font-semibold uppercase not-italic leading-5 tracking-tighter;
