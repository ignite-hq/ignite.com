<template>
  <div class="container-full container px-5 sm:px-5.5 l:px-7">
    <div class="grid grid-cols-1 gap-6 m:gap-7 l:grid-cols-12 xl:grid-cols-2">
      <div
        class="px-0 l:col-span-8 l:col-start-3 xl:col-span-1 xl:col-start-auto"
      >
      ...
      <div class="px-0 l:col-span-12 xl:col-span-2">
