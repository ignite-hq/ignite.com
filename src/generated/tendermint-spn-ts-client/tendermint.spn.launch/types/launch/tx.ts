...
export const MsgEditChain = {
  encode(message: MsgEditChain, writer: Writer = Writer.create()): Writer {
    ...
    if (message.setCampaignID === true) {
      writer.uint32(24).bool(message.setCampaignID);
    }
    if (message.campaignID !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.setCampaignID = reader.bool();
          break;
        case 4:
          message.campaignID = longToNumber(reader.uint64() as Long);
          break;
  ...
  fromJSON(object: any): MsgEditChain {
    ...
    if (object.setCampaignID !== undefined && object.setCampaignID !== null) {
      message.setCampaignID = Boolean(object.setCampaignID);
    } else {
      message.setCampaignID = false;
    }
    if (object.campaignID !== undefined && object.campaignID !== null) {
      message.campaignID = Number(object.campaignID);
    } else {
  ...
  toJSON(message: MsgEditChain): unknown {
    ...
    message.coordinator !== undefined &&
      (obj.coordinator = message.coordinator);
    message.launchID !== undefined && (obj.launchID = message.launchID);
    message.setCampaignID !== undefined &&
      (obj.setCampaignID = message.setCampaignID);
    message.campaignID !== undefined && (obj.campaignID = message.campaignID);
    message.metadata !== undefined &&
      (obj.metadata = base64FromBytes(
        message.metadata !== undefined ? message.metadata : new Uint8Array()
  ...
  fromPartial(object: DeepPartial<MsgEditChain>): MsgEditChain {
    ...
    if (object.setCampaignID !== undefined && object.setCampaignID !== null) {
      message.setCampaignID = object.setCampaignID;
    } else {
      message.setCampaignID = false;
    }
    if (object.campaignID !== undefined && object.campaignID !== null) {
...
export const MsgRequestAddValidator = {
  encode(
    ...
    if (message.peer !== undefined) {
      Peer.encode(message.peer, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },
...
export const MsgTriggerLaunch = {
  encode(message: MsgTriggerLaunch, writer: Writer = Writer.create()): Writer {
    ...
    if (message.remainingTime !== 0) {
      writer.uint32(24).int64(message.remainingTime);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.remainingTime = longToNumber(reader.int64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
