...
class Ignite {
  ...
  constructor({ env }: IgniteParams) {
    ...
    this.TendermintFundraising = new TendermintFundraising(this._env.apiURL)
    this.TendermintSpnCampaign = new TendermintSpnCampaign(this._env.apiURL)
    this.TendermintSpnLaunch = new TendermintSpnLaunch(this._env.apiURL)
    ...
    this.TendermintSpnProfile = new TendermintSpnProfile(this._env.apiURL)
    this.TendermintSpnReward = new TendermintSpnReward(this._env.apiURL)
  }
