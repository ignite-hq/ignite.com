...
import {
  Module as TendermintSpnCampaign,
  msgTypes as TendermintSpnCampaignMsgTypes
} from './tendermint.spn.campaign'
import {
  Module as TendermintSpnLaunch,
  msgTypes as TendermintSpnLaunchMsgTypes
} from './tendermint.spn.launch'
import {
  Module as TendermintSpnMonitoringc,
  msgTypes as TendermintSpnMonitoringcMsgTypes
} from './tendermint.spn.monitoringc'
import {
  Module as TendermintSpnMonitoringp,
  msgTypes as TendermintSpnMonitoringpMsgTypes
} from './tendermint.spn.monitoringp'
import {
  Module as TendermintSpnParticipation,
  msgTypes as TendermintSpnParticipationMsgTypes
} from './tendermint.spn.participation'
import {
  Module as TendermintSpnProfile,
  msgTypes as TendermintSpnProfileMsgTypes
} from './tendermint.spn.profile'
import {
  Module as TendermintSpnReward,
...
function plugTendermintFundraising(env: Environment): {
...
function plugTendermintSpnCampaign(env: Environment): {
  tendermintSpnCampaign: TendermintSpnCampaign
} {
  return {
    tendermintSpnCampaign: new TendermintSpnCampaign(env.apiURL)
  }
}

function plugTendermintSpnLaunch(env: Environment): {
  tendermintSpnLaunch: TendermintSpnLaunch
} {
  return {
    tendermintSpnLaunch: new TendermintSpnLaunch(env.apiURL)
  }
}

function plugTendermintSpnMonitoringc(env: Environment): {
  tendermintSpnMonitoringc: TendermintSpnMonitoringc
} {
  return {
    tendermintSpnMonitoringc: new TendermintSpnMonitoringc(env.apiURL)
  }
}

function plugTendermintSpnMonitoringp(env: Environment): {
...
function plugTendermintSpnParticipation(env: Environment): {
  tendermintSpnParticipation: TendermintSpnParticipation
} {
  return {
    tendermintSpnParticipation: new TendermintSpnParticipation(env.apiURL)
  }
}

function plugTendermintSpnProfile(env: Environment): {
  tendermintSpnProfile: TendermintSpnProfile
} {
  return {
    tendermintSpnProfile: new TendermintSpnProfile(env.apiURL)
  }
}

function plugTendermintSpnReward(env: Environment): {
  tendermintSpnReward: TendermintSpnReward
} {
  return {
...
type Ignite = ReturnType<typeof plugCosmosAuthV1Beta1> &
  ...
  ReturnType<typeof plugTendermintSpnCampaign> &
  ReturnType<typeof plugTendermintSpnLaunch> &
  ReturnType<typeof plugTendermintSpnMonitoringc> &
...
let createIgnite = (p: { env: Environment }) =>
  _use({
    ...
    ...plugTendermintSpnCampaign(p.env),

    ...plugTendermintSpnLaunch(p.env),

    ...plugTendermintSpnMonitoringc(p.env),

    ...plugTendermintSpnMonitoringp(p.env),

    ...plugTendermintSpnParticipation(p.env),
...
export {
  ...
  plugTendermintSpnCampaign,
  plugTendermintSpnLaunch,
  plugTendermintSpnMonitoringc,
