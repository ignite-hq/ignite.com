...
function plugTendermintSpnCampaign(env: Env): {
...
function plugTendermintSpnLaunch(env: Env): {
...
function plugTendermintSpnMonitoringc(env: Env): {
...
function plugTendermintSpnParticipation(env: Env): {
...
function plugTendermintSpnProfile(env: Env): {
...
function plugTendermintSpnReward(env: Env): {
...
type Spn = ReturnType<typeof plugTendermintSpnCampaign> &
