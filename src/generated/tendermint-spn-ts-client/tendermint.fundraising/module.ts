...
class Module extends Api<any> {
  ...
  async sendMsgCreateEnglishAuction({
    ...
    if (!this._client) {
      throw new Error(
        'TxClient:sendMsgCreateEnglishAuction: Unable to sign Tx. Signer is not present.'
      )
    }
    if (!this._addr) {
      throw new Error(
        'TxClient:sendMsgCreateEnglishAuction: Unable to sign Tx. Address is not present.'
      )
    }
    try {
      ...
      throw new Error(
        'TxClient:sendMsgCreateEnglishAuction: Could not broadcast Tx: ' +
          e.message
      )
    }
  }
  ...
  msgCreateEnglishAuction({
    ...
    try {
      ...
      throw new Error(
        'TxClient:MsgCreateEnglishAuction: Could not create message: ' +
          e.message
      )
    }
  }
