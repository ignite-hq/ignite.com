...
function useModule(): Response {
  ...
  let {
    ...
    queryDenomsMetadata
  } = unref(spn.cosmosBankV1Beta1)

  sendMsgMultiSend = sendMsgMultiSend.bind(spn.cosmosBankV1Beta1)

  sendMsgSend = sendMsgSend.bind(spn.cosmosBankV1Beta1)

  queryBalance = queryBalance.bind(spn.cosmosBankV1Beta1)

  queryAllBalances = queryAllBalances.bind(spn.cosmosBankV1Beta1)

  querySpendableBalances = querySpendableBalances.bind(spn.cosmosBankV1Beta1)

  queryTotalSupply = queryTotalSupply.bind(spn.cosmosBankV1Beta1)

  querySupplyOf = querySupplyOf.bind(spn.cosmosBankV1Beta1)

  queryParams = queryParams.bind(spn.cosmosBankV1Beta1)

  queryDenomMetadata = queryDenomMetadata.bind(spn.cosmosBankV1Beta1)

  queryDenomsMetadata = queryDenomsMetadata.bind(spn.cosmosBankV1Beta1)
